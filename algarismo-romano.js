// Algarismo Romano | Mateus dos Santos Pereira | 26/04/2024
...
let arabico = Number(prompt("Digite o número arábico"));
let text;

if (arabico > 0 && arabico < 4000000) {
    text = romanNumeral(arabico);
} else {
    text = `Erro. Digite um número maior que 0 e menor que 4000000`;
}
